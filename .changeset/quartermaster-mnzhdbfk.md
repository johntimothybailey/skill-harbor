...
- **Quartermaster as a Harbor skill**: Added a shared `.harbor/skills/quartermaster` skill and wired it into the project manifest so this repo can use Quartermaster through Harbor instead of only through `bun run quartermaster`.
