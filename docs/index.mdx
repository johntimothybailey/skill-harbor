...
<CardGroup cols={2}>
  ...
  <Card title="🧭 Sources vs Targets" icon="route" href="/docs/foundations/sources-and-targets">
    Learn the difference between where skills come from, where Harbor generates them to, and how folder-backed sources like `~/.rulesync/skills` fit into the model.
  </Card>
