...
For details on what counts as a ghost, how commands surface them, and how ghost docking differs from managed folder-backed sources, see [Ghosts](/docs/foundations/ghosts).
