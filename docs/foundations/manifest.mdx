...
Your **personal fleet** — skills that follow you across every project on your machine. Registered with `skill-harbor dock <url> --global` and synced with `skill-harbor up --global`. See [Global Fleet](/docs/foundations/global-fleet) for details.
...
```
⚠️  Local Override: The following skills are being overridden by personal definitions:
   - my-skill
```
