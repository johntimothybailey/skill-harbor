...
To safely chain skills together, Harbor monitors **Engagements** via input/output contracts.

### `## Requires`
Defines the context state or variables the skill needs.
- **Example**:
```markdown
## Requires
...
### `## Produces`
Defines the predictable output the skill guarantees.
- **Example**:
```markdown
## Produces
...
While the **Skill Standard** defines the *content* of a skill, the **[Manifest & .harbor Folder](/concepts/manifest)** defines how that skill is tracked, versioned, and delivered to your agent fleet.
