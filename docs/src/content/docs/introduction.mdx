...
- **Multi-Platform Support**: Automatic distribution to **Claude Code**, **Cursor**, **Codex**, and **Antigravity**.
...
- **Cross-Platform Transpilation**: Powered by `skill-porter` to convert skill formats between Gemini and Claude seamlessly.
