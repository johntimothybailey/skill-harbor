...
> Already have unmanaged skills living in active berths? `skill-harbor fathom --ghosts` remains the quickest way to discover and dock them interactively.
...
- `fathom --ghosts` still exists as the ghost-aware inspection mode inside Fathom.
